          ...
          <div className="group relative">
            ...
            <div className="relative bg-white/90 backdrop-blur-sm rounded-3xl p-12 shadow-xl transition-all duration-700 group-hover:shadow-3xl group-hover:bg-white/95">
              ...
              <div className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity duration-700">
                <div 
                  className="absolute inset-0 bg-[linear-gradient(45deg,var(--color-navy-400)_1px,transparent_1px),linear-gradient(-45deg,var(--color-navy-400)_1px,transparent_1px)] bg-[length:20px_20px] rounded-3xl"
                ></div>
              </div>
              ...
              <form onSubmit={handleSubmit} className="relative space-y-8">
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      style={{ 
                        borderColor: errors.firstName ? "var(--color-terracotta-400)" : "var(--color-terracotta-200)",
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="w-full px-6 py-4 rounded-xl border-2 font-frutiger text-lg transition-all duration-300 focus:scale-[1.02] focus:shadow-lg"
                      style={{ 
                        borderColor: errors.lastName ? "var(--color-terracotta-400)" : "var(--color-terracotta-200)",
                        backgroundColor: "white",
                        color: "var(--color-charcoal-700)"
                      }}
                    />
                ...
                <div>
                  ...
                  <textarea
                    ...
                    style={{ 
                      borderColor: errors.message ? "var(--color-terracotta-400)" : "var(--color-terracotta-200)",
                      backgroundColor: "white",
                      color: "var(--color-charcoal-700)"
                    }}
                  />
