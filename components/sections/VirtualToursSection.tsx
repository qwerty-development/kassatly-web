    ...
    <section id="tours" className="py-32 relative overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl px-6">
        ...
        <div className="text-center mb-20">
          ...
          >
            Experience our state-of-the-art facilities through cutting-edge
            virtual reality
          </p>
        </div>
            ...
            >
              ...
              <Card className="relative p-12 text-center bg-white/80 backdrop-blur-sm border-0 shadow-xl rounded-3xl overflow-hidden transition-all duration-700 group-hover:shadow-3xl group-hover:bg-white/90">
                ...
                <div className="absolute inset-0 opacity-5 group-hover:opacity-10 transition-opacity duration-700">
                  <div className="absolute inset-0 bg-[linear-gradient(45deg,var(--color-brand-primary)_1px,transparent_1px),linear-gradient(-45deg,var(--color-brand-primary)_1px,transparent_1px)] bg-[length:20px_20px]"></div>
                </div>
          ...
          >
            <div className="mb-6">
              ...
              <p
                ...
                style={{ color: "var(--color-charcoal-600)" }}
              >
                Discover 50+ years of beverage excellence through our
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              >
                <div className="flex items-center justify-center">
                  <svg
                    className="mr-3 w-5 h-5 transition-transform duration-300 group-hover/cta:scale-110"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
