...
export const ProductsSection: React.FC = () => {
  return (
    <section id="products" className="py-12 sm:py-16 lg:py-24 relative overflow-hidden bg-white">
            ...
            <div className="relative p-6 sm:p-8 lg:p-10 rounded-xl sm:rounded-2xl lg:rounded-3xl bg-gradient-to-br from-navy-50/80 via-white to-beige-50/80 border border-navy-100/50 backdrop-blur-sm transition-all duration-500 hover:scale-[1.02] hover:shadow-2xl overflow-hidden">
              ...
              <div className="relative z-10">
                ...
                <div className="inline-flex items-center px-3 sm:px-4 lg:px-6 py-1.5 sm:py-2 lg:py-3 rounded-full bg-gradient-to-r from-terracotta-100/80 to-navy-100/80 border border-terracotta-200/50 mb-4 sm:mb-6 lg:mb-8 transition-all duration-300 hover:scale-105">
                  ...
                  <span className="text-xs sm:text-sm font-frutiger-bold tracking-wider uppercase" style={{ color: "var(--color-brand-primary)" }}>
                    Heritage Experience
                  </span>
                </div>
                
                {/* Enhanced title */}
                <h4 className="text-xl sm:text-2xl lg:text-3xl font-frutiger-bold mb-3 sm:mb-4 lg:mb-6 transition-all duration-300 group-hover:scale-[1.02]" style={{ color: "var(--color-brand-primary)" }}>
                  <span className="block mb-1">Discover Our</span>
                  <span className="block bg-gradient-to-r from-terracotta-500 to-navy-600 bg-clip-text text-transparent">Heritage</span>
                </h4>
                
                {/* Enhanced description */}
                <p className="text-sm sm:text-base lg:text-lg font-frutiger mb-4 sm:mb-6 lg:mb-8 max-w-xl mx-auto leading-relaxed transition-all duration-300" style={{ color: "var(--color-charcoal-600)" }}>
                  Experience <span className="font-frutiger-bold text-terracotta-600">50+ years</span> of beverage excellence through our immersive virtual tours
                </p>
                ...
                >
                  ...
                  <div className="relative flex items-center">
                    <svg className="mr-2 sm:mr-3 lg:mr-4 w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 group-hover/btn:scale-110 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 10l4.553-2.276A1 1 0 0121 8.618v6.764a1 1 0 01-1.447.894L15 14M5 18h8a2 2 0 002-2V8a2 2 0 00-2-2H5a2 2 0 00-2 2v8a2 2 0 002 2z" />
                    </svg>
                    <span className="transition-all duration-300">Virtual Tours</span>
                    <svg className="ml-2 sm:ml-3 lg:ml-4 w-4 h-4 sm:w-5 sm:h-5 lg:w-6 lg:h-6 group-hover/btn:translate-x-1 transition-all duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
