      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 relative">
        <div className="grid gap-16 lg:gap-20 lg:grid-cols-2 items-start">
            ...
            >
              ...
              >
                <p
                  ...
                  style={{ color: "var(--color-brand-primary)" }}
                >
                  "The beloved creation proved successful, introducing Kassatly
                  Chtaura as a repute and innovative establishment."
                </p>
              </div>
            </motion.div>
          ...
          >
            <div className="relative group w-full max-w-lg mx-auto">
              ...
              >
                <span className="text-base sm:text-lg text-white leading-none">
                  First
                </span>
                <span className="text-sm sm:text-base opacity-90 font-frutiger-bold">
                  Jallab
                </span>
        ...
        >
          {COMPANY_STATS.map((stat, index) => (
            <motion.div
              key={index}
              className="text-center p-4 sm:p-6 lg:p-8 transition-all duration-300 hover:bg-navy-700 cursor-pointer"
              style={{ color: "white" }}
              variants={itemVariants}
            >
              <div className="relative">
                <div className="text-3xl sm:text-5xl lg:text-6xl font-frutiger-bold mb-1">
                  {stat.value}
                </div>
                <div
                  className="text-xs sm:text-base font-frutiger tracking-wider uppercase opacity-80 leading-tight"
